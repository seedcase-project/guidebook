...
The reason to start writing documentation before writing code is that
often the desire to write documentation drops substantially once coding
...
documentation *before writing any code*. This approach helps with
finding any issues with the design. As you write the docs from the
perspective and needs of the user (who might also be you), you will very
likely encounter issues or gaps in the design. Then you can go back and
adjust the design to resolve these issues. It also helps clarify to
yourself and any contributors or team members how the software is
supposed to work and how to use it, which can help guide the
