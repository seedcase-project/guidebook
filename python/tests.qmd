...
However, there is some developer judgement involved here. Sometimes
internal code might be a bit complicated or does some non-standard
stuff. You can use tests to verify your expectations and also
communicate to your collaborators or reviewers what the code actually
does. This should be something that should be done infrequently though.
:::
