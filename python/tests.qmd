...
- Every possible use of a class, such as initiating it and accessing its
  attributes.
...
tests by using
[parameterized tests](https://docs.pytest.org/en/7.1.x/how-to/parametrize.html)
to test multiple inputs and outputs with the same test function.
:::
