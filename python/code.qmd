...
1.  An individual public-facing functionality has its own Python file.
    ...
    file, but if the functionality is similar enough to others, they
...
-   Using clear inputs and one type of output in functions or methods.
...
We tend to prefer the first option, as explicitly stating the function
used makes it easier to know what the script is using from internals.
